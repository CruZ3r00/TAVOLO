...
<template>
    <AppLayout>
        ...
        <section class="d-flex align-items-center justify-content-center" style="height: 60vh; position: relative; background-color: #27ae60; background-size: cover; background-position: center;">
